...
export async function initClient(): Promise<void> {
    ...
    // Initialize the GAPI client first without discovery docs.
    await gapi.client.init({
        apiKey: API_KEY,
    });

    // Then, load the Drive API discovery document.
    // This separation can be more robust against initialization issues.
